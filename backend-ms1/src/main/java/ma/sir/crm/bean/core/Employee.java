...
public class Employee   extends AuditBusinessObject     {
    ...
    @Column(length = 500)
    private String cnss;
    private BigDecimal durreConge = BigDecimal.ZERO;
    ...
    public BigDecimal getDurreConge(){
        return this.durreConge;
    }
    public void setDurreConge(BigDecimal durreConge){

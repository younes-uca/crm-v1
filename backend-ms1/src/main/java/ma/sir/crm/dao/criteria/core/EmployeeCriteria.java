...
public class EmployeeCriteria extends  BaseCriteria  {
    ...
    private String durreConge;
    private String durreCongeMin;
    private String durreCongeMax;
    ...
    public String getDurreConge(){
        return this.durreConge;
    }
    public void setDurreConge(String durreConge){
        this.durreConge = durreConge;
    }   
    public String getDurreCongeMin(){
        return this.durreCongeMin;
    }
    public void setDurreCongeMin(String durreCongeMin){
        this.durreCongeMin = durreCongeMin;
    }
    public String getDurreCongeMax(){
        return this.durreCongeMax;
    }
    public void setDurreCongeMax(String durreCongeMax){
        this.durreCongeMax = durreCongeMax;
    }

...
import ma.sir.crm.bean.core.*;
import ma.sir.crm.service.facade.admin.*;

import ma.sir.crm.zynerator.security.common.AuthoritiesConstants;
import ma.sir.crm.zynerator.security.bean.User;
import ma.sir.crm.zynerator.security.bean.Permission;
import ma.sir.crm.zynerator.security.bean.Role;
import ma.sir.crm.zynerator.security.service.facade.UserService;
import ma.sir.crm.zynerator.security.service.facade.RoleService;
...
@EnableCaching
//@EnableFeignClients("ma.sir.crm.required.facade")
public class CrmApplication {
    public static ConfigurableApplicationContext ctx;

    public static void main(String[] args) {
        ctx=SpringApplication.run(CrmApplication.class, args);
    }

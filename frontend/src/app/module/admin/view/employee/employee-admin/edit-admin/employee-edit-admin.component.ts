...
export class EmployeeEditAdminComponent extends AbstractEditController<EmployeeDto, EmployeeCriteria, EmployeeService>   implements OnInit {
    ...
    constructor( private employeeService: EmployeeService , private absenceService: AbsenceService, private congeService: CongeService, private contratService: ContratService, private typeAbsenceService: TypeAbsenceService, private uniteAdministrativeService: UniteAdministrativeService, private typeCongeService: TypeCongeService, private categorieEmployeeService: CategorieEmployeeService) {

...
export class EmployeeListAdminComponent extends AbstractListController<EmployeeDto, EmployeeCriteria, EmployeeService>  implements OnInit {
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'durreConge', header: 'Durre conge'},
   ...
   public prepareColumnExport() : void {
        ...
        this.criteriaData = [{
            ...
            'Durre conge Min': this.criteria.durreCongeMin ? this.criteria.durreCongeMin : environment.emptyForExport ,
            'Durre conge Max': this.criteria.durreCongeMax ? this.criteria.durreCongeMax : environment.emptyForExport ,
